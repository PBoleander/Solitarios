...
public class VisorMontosB extends JPanel {
    ...
    public VisorMontosB(Monto[] montosInferiores, Monto montoReserva, Monto montoManoPorSacar, Monto montoManoSacado) {
        ...
        final Insets insetsOriginal = new Insets(vGap, hGap, vGap, hGap);
        ...
        c.gridheight = 1;
        c.insets = new Insets(Naipe.ALTO + vGap, hGap, vGap, hGap);
        c.gridx = 0;
        c.gridy = 1;
